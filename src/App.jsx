  ...
  return (
    <Container>
        ...
        <InputGroup className="my-5 w-50 d-flex flex-column">
          <div className="d-flex gap-3">
            <div className="d-flex border rounded w-100">
              <InputGroup.Text id="basic-addon1" className="border-0 rounded-0">
                <IoSearchOutline />
              </InputGroup.Text>
              <Form.Control
                name="tag"
            ...
            <button
              type="submit"
              className="border-0 rounded-right rounded-2 px-3 bg-primary text-white"
            >
              OK
            </button>
          </div>
      ...
      <Row>
        <Col
          className={`d-flex justify-content-center ${
            searchResult.length ? "flex-column align-items-center gap-5" : ""
          }`}
        >
          {!errors ? (
            <>
      ...
      <Row className="py-5">
        <Col className="d-flex justify-content-center w-full gap-4 align-items-center">
          <Button
            disabled={currentPage === 1 || searchResult.length ? true : false}
            onClick={onPrevPage}
          >
            Prev
          </Button>
          ...
          <Button
            disabled={
              currentPage === feeds.length || searchResult.length ? true : false
            }
            onClick={onNextPage}
          >
            Next
